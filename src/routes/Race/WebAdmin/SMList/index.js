                                    ...
                                    <Card hoverable size='lg' onClick={async (e) => {
                                        ...
                                        <Container>
                                            <Row style={{ marginTop: -10 }}>
                                                ...
                                                <Col sm={4}>
                                                    <h3><Tag style={{ fontSize: 18 }} color='blue'>{i.sm}</Tag></h3>
                                                </Col>
                                            </Row>
                                            <Row className='mt-3'>
                                                <Row style={{ backgroundColor: "" }}>
                                                    ...
                                                    <Col sm={6} md={4}>
                                                        <p style={{ marginBottom: "0px", fontWeight: "bold", display: "", justifyContent: "" }}>Tanggal Pick Up</p>
                                                    </Col>

                                                    <Col sm={4} md={4}>
                                                        <p style={{ marginTop: "", fontWeight: "bold" }}>Kendaraan Pickup</p>
                                                    </Col>
                                                </Row>
                                                <Row>
                                                    <Col sm={6} md={4}>
                                                    ...
                                                    <Col md={4}>
                                                        <p style={{ backgroundColor: "", fontWeight: "bold", }}><Tag color="blue">{i.tglPickup}</Tag></p>
                                                    </Col>
                                                    <Col sm={6} md={4} >
                                                        <p style={{ marginTop: "0px", fontWeight: "bold" }}><Tag color="green">{i?.kendaraanPickup}</Tag> </p>
                                                    </Col>
                                            ...
                                            <Row style={{ backgroundColor: "" }}>
                                                <Col >
                                                    <div style={{ marginTop: "", fontWeight: "bold" }}>Destination</div>
                                                    <div style={{ marginTop: "", fontWeight: "bold" }}><Tag color="teal">{i.destination}</Tag></div>
                                                </Col>
                                                <Col style={{}}>
                                                    <div style={{ justifyContent: "end", display: "flex", marginTop: "", fontWeight: "bold" }}>Nama Driver</div>
                                                    <div style={{ justifyContent: "end", display: "flex", marginTop: "", fontWeight: "bold" }}><Tag color='purple'>{i?.driver1}</Tag></div>
                                                </Col>
                                            </Row>
                                        </Container>
                                    </Card>
