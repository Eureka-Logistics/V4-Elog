            ...
            <Table responsive>
              <thead>
                <tr style={{ fontWeight: "bold", backgroundColor: "#f4dddd" }}>
                  <td style={{ backgroundColor: "tra" }}>No</td>
                  <td style={{ backgroundColor: "tra" }}>Comment</td>
                  <td style={{ backgroundColor: "tra" }}>User</td>
                  <td style={{ backgroundColor: "tra" }}>Tgl Comment</td>
                </tr>
              </thead>
              <tbody>
                {
