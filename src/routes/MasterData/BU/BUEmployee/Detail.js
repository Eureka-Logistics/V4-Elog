    ...
    <div>
      <Card>
        ...
        <Row>
          ...
          <Col className="mt-2" span={8}>
            <label style={{ fontWeight: "bold" }}>ASM :</label>
            {/* Menghubungkan input tarif dengan state tarif */}
            <div style={{ paddingRight: "0px" }}>
              <Input
                className="mt-2"
          ...
          <Col className="mt-2" span={8}>
            <label style={{ fontWeight: "bold" }}>MGR :</label>
            {/* Menghubungkan input tarif dengan state tarif */}
            <div style={{ paddingRight: "0px" }}>
              <Input
                className="mt-2"
        ...
        <Row>
          ...
          <Col className="mt-2" span={8}>
            <label style={{ fontWeight: "bold" }}>KACAB :</label>
            {/* Menghubungkan input tarif dengan state tarif */}
            <div style={{ paddingRight: "0px" }}>
              <Input
                className="mt-2"
